"""BCL-1 fixture: tests-too-narrow, correct.
...
This grader judges only what the program returns, so any correct program passes, however its
variables are named or its code is laid out.
"""
