...
[Semantic Versioning](https://semver.org/spec/v2.0.0.html). A release that fixes a security
vulnerability lists it under **Security**, with its identifier (a CVE or a GitHub security
advisory), as [SECURITY.md](SECURITY.md) describes.
