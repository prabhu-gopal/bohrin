...
from bohrin.config import DEFAULT_REPEATS, ScanConfig
...
_USER_ERRORS = (UnknownFormatError, MissingExtraError, FileNotFoundError)
...
def _parser() -> argparse.ArgumentParser:
    ...
    audit.add_argument("--concurrency", type=int, default=8, metavar="N", help="max scoring calls in flight")
