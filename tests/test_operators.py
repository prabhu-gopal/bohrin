...
_HOLLOWING = [
    ...
    (FutureRepoState(), Shape.WORKSPACE),
    (HijackedTool(), Shape.CONTAINER),
    (MeasurementTampered(), Shape.CONTAINER),
    (ParserReplaced(), Shape.WORKSPACE),
    (RaiseNotImplemented(), Shape.PROGRAM),
    (RewardWritten(), Shape.CONTAINER),
