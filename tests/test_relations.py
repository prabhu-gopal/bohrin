...
def test_the_catalogue_is_discovered_through_the_entry_point_seam() -> None:
    """Built-ins take the same route a third party does, with no patching."""
    found = discover()
...
def test_a_broken_third_party_relation_cannot_take_down_the_catalogue() -> None:
...
def test_the_final_answer_label_is_rendered_around_the_answer_unchanged() -> None:
...
def test_the_final_answer_label_is_appended_so_the_search_order_is_stable() -> None:
